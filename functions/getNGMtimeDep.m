...
NGM =     u * diag(par.ui) * C_detBalNow' * diag(par.pClin + par.cSub*(1-par.pClin));    % Set final NGM
NGMclin = u * diag(par.ui) * C_detBalNow';                                           % NGM for clinical individuals (as used in simulation models)
